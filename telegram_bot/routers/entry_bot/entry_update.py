...
async def get_entry(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Enter the updated title of entry:", reply_markup=create_cancel_button()
    )
...
async def get_title(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Now the updated description:", reply_markup=create_cancel_button()
    )
...
async def get_description(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Now the updated tags(separated by commas):",
...
async def get_tags(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Now the updated mood score:", reply_markup=create_cancel_button()
    )
...
async def get_mood(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Now the updated progress score:", reply_markup=create_cancel_button()
    )
...
async def get_progress(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        "Now the updated learning hours:", reply_markup=create_cancel_button()
    )
...
async def get_hours(message: types.Message, state: FSMContext):
    ...
    await message.answer(
        ...
        reply_markup=create_yes_no_buttons("private_update"),
    )
...
async def add_private(cb: CallbackQuery, state: FSMContext):
    ...
    await cb.message.answer(
        ...
        reply_markup=create_yes_no_buttons("topics_update"),
    )
...
async def wait_topics(cb: CallbackQuery, state: FSMContext, token: str):
    ...
    if cb.data == "yes_topics_update":
        ...
        await cb.message.answer(
            "Choose the topics:", reply_markup=create_topics_buttons(topics)
        )
